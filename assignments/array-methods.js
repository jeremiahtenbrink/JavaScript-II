...
// Problem 1
// list out all the company names and how much they donated.
runners.forEach(function (runner) {
	console.log(`${runner.company_name} donated $${runner.donation}.`);
});



// Problem 2
//count how many small shirts we need to order.

const smallShirts = runners.reduce(function (accumulator, runner) {
